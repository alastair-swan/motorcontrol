                ...
                <Grid2 container spacing={1} columns={2}>
                    <Grid2 size={1} spacing={1}>
                        <Grid2 container spacing={1}>
                            ...
                            <Client.StandbyModeSwitch motorNumber = {motorNumber} initialState = {await GetParam(motorNumber, 'STBY_MODE') === 1} itembgHoverColor={itembgHoverColor} itembgColor={itembgColor}/>
                            ...
                            <Client.SpeedInputInversionSwitch motorNumber = {motorNumber} initialState = {await GetParam(motorNumber, 'SPDINV') === 1} itembgHoverColor={itembgHoverColor} itembgColor={itembgColor}/>
                            <Client.ErrorLatchSwitch motorNumber = {motorNumber} initialState = {await GetParam(motorNumber, 'LATCH') === 1} itembgHoverColor={itembgHoverColor} itembgColor={itembgColor}/>
                            ...
                            <Client.ForceForcedComutationSwitch motorNumber = {motorNumber} initialState = {await GetParam(motorNumber, 'LOCKDIS') === 1} itembgHoverColor={itembgHoverColor} itembgColor={itembgColor}/>
                            ...
                            <Client.OvercurrentDetectionThresholdSwitch motorNumber = {motorNumber} initialState = {await GetParam(motorNumber, 'ISD_LVL') === 1} itembgHoverColor={itembgHoverColor} itembgColor={itembgColor}/>
